				...
				<td style="text-align: right;" valign="top">
					...
					<div class="left_labels">
						...
						<table class="labels_table" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td><a href="index.s?tId=${tag.tId}">${tag.tName}</a></td>
							</tr>
							</c:forEach>
				...
				<td>
					...
					<div class="content_links">
						...
						<div style="padding: 6px 10px;">
							<div>
								<a href="http://${fav.fUrl }"
									style="color: blue; font-size: 18px;" target="_blank">${fav.fLabel }</a>
							</div>
							<div style="color: black; font-size: 16px;">${fav.fDesc }</div>
